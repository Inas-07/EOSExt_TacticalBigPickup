...
namespace EOSExt.TacticalBigPickup.Impl.FogBeacon.LeveSpawned
{
    public class LevelSpawnedFogBeacon
    {
        ...
        public static LevelSpawnedFogBeacon Instantiate(eDimensionIndex dimensionIndex, LG_LayerType layer, eLocalZoneIndex localIndex, LevelSpawnedFogBeaconSettings def)
        {
            ...
            {
                EOSLogger.Error($"LevelSpawnedFogBeaconManager: ItemDatablock Definition of vanilla Fog Repeller Turbine is not found...");
                return null;
            }
            ...
            {
                EOSLogger.Error($"LevelSpawnedFogBeacon: cannot find {(dimensionIndex, layer, localIndex)}, Area_{(char)('A' + def.AreaIndex)}");
                return null;
            }
        ...
        {
            Object.Destroy(LG_PickupItem.m_root.gameObject);
            GlobalState = null;
            LG_PickupItem = null;
            def = null;
        }
        ...
        private LevelSpawnedFogBeacon(LevelSpawnedFogBeaconSettings def, AIG_CourseNode node)
        {
            ...
            {
                EOSLogger.Error($"LevelSpawnedFogBeaconManager: Didn't find GlobalState of '{def.WorldEventObjectFilter}'");
                return;
            }
