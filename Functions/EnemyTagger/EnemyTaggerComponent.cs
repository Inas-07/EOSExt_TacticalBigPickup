...
namespace EOSExt.TacticalBigPickup.Functions.EnemyTagger
{
    ...
    {
        private const float INACTIVE_SOUND_UPDATE_INTERVAL = 4.0f;
        ...
        public void ChangeState(eEnemyTaggerState newState)
        {
            ...
            switch (newState)
            {
                case eEnemyTaggerState.Uninitialized:
                    EOSLogger.Error("Enemy Tagger changed to state 'uninitialized'?");
                    return;
                ...
                case eEnemyTaggerState.Active_Tagging:
                    ...
                    break;
                default:
                    EOSLogger.Error($"Enemy Tagger: Undefined state {CurrentState}");
                    return;
            }
        ...
        void Update()
        {
            ...
            if (Parent == null)
            {
                EOSLogger.Error("EnemyTagger: null parent");
                return;
            }
